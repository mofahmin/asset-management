...
export default function AssetPage() {
  ...
  const columns = [
    ...
    },
    {
      ...
      sortable: true,
      render: (value) => value ? new Date(value).toLocaleDateString("ms-MY") : "-",
    },
    {
      key: "value",
      label: "Nilai (RM)",
      sortable: true,
      render: (value) => value ? Number(value).toLocaleString("ms-MY", { minimumFractionDigits: 2 }) : "-",
    },
    {
      key: "location",
      label: "Penempatan",
    ...
    },
    {
      ...
      sortable: true,
      searchable: true,
      render: (value) => <Badge className={getStatusBadgeColor(value)}>{value}</Badge>,
    },
  ]
